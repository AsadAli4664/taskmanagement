    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <a href="{{ route('userdashboard.useralltasks', ['id' => $idd]) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          ...
          <a href="{{ route('userdashboard.completedtasks', ['id' => $idd]) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          ...
          <a href="{{ route('userdashboard.userincompleted', ['id' => $idd]) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
      ...
      name: 'Projects',
            ...
            data: [
              <?php 
                ...
                foreach($taskchart as $subtask){ ?>
                  {
                      name: '{{$subtask->title}}',
                      y: {{$subtask->progress}},
                      url: '{{route('task.subtask_list', ['id' => $subtask->id])}}', // Add the URL you want to link to
                  },
                  <?php }
